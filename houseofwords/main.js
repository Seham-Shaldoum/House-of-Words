...
let face = "Eyes, mouth, and nose connected together by skin"; /*Between the quotation marks, 
...
let red = "warm"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "processor"; //repeat the instructions for the word "brain"

let masculine = "angry"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "quiet"; //define 'think' in VERB form,
